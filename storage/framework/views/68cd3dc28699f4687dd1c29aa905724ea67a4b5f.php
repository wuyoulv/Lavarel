                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        ...
                        <input type="text" disabled="disabled" name="user" class="form-control" id="inputEmail3" value="<?php echo e($v->name); ?>" placeholder="">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input type="text" disabled="disabled" name="title" class="form-control" id="inputEmail3" value="<?php echo e($v->title); ?>" placeholder="">
                      </div>
                    </div>
