                ...
                <form action="<?php echo e(URL('admin/user')); ?>/<?php echo e($user->id); ?>" method="post" class="form-horizontal">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                      <input readonly id="inputEmail3" placeholder="账号" type="text" name="account" class="form-control" value="<?php echo e($user->account); ?>"/>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                      <img width="60" src="<?php echo e(URL('uploads')); ?>/<?php echo e($user->picname); ?>"/>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                      <input readonly id="inputEmail3" placeholder="真实姓名" type="text" name="name" class="form-control" value="<?php echo e($user->name); ?>"/>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                      <input readonly id="inputEmail3" placeholder="生日" type="text" name="birthday" class="form-control" value="<?php echo e($user->birthday); ?>"/>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input type="radio" readonly name="sex" value="1" <?php if($user->sex == 1): ?> checked <?php endif; ?>>男  &nbsp; &nbsp; 
                        <input type="radio" readonly name="sex" value="2" <?php if($user->sex == 2): ?> checked <?php endif; ?>>女
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="inputEmail3" class="col-sm-2 control-label">电话：</label>
                      <div class="col-sm-4">
                      <input readonly id="inputEmail3" placeholder="电话" type="text" name="tel" class="form-control" value="<?php echo e($user->tel); ?>"/>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                      <input readonly id="inputEmail3" placeholder="邮箱" type="text" name="email" class="form-control" value="<?php echo e($user->email); ?>"/>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                      <input readonly id="inputEmail3" placeholder="地址" type="text" name="address" class="form-control" value="<?php echo e($user->address); ?>"/>
