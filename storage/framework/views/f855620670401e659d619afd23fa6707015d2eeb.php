            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs"><?php echo e(session()->get('adminuser')); ?></span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="<?php echo e(URL('admin/userlog')); ?>"><i class="fa fa-youtube-play"></i> 登陆管理</a></li>
                <li class="active"><a href="<?php echo e(URL('admin/user')); ?>"><i class="fa fa-youtube-play"></i> 会员管理</a></li>
                <li class="active"><a href="<?php echo e(URL('admin/user/create')); ?>"><i class="fa fa-youtube-play"></i> 添加会员</a></li>
              </ul>
            </li> 
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="<?php echo e(url('admin/user_vip')); ?>"><i class="fa fa-circle-o"></i> 浏览VIP会员</a></li>
                <li><a href="<?php echo e(url('admin/user_vip/create')); ?>"><i class="fa fa-circle-o"></i> 添加VIP会员</a></li>
              </ul>
            </li>
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="<?php echo e(url('admin/logins')); ?>"><i class="fa fa-circle-o"></i> 登陆信息</a></li>
                <li><a href="<?php echo e(url('admin/user_film')); ?>"><i class="fa fa-circle-o"></i> 用户与电影</a></li>
              </ul>
            </li>
            <li class="active treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="<?php echo e(url('admin/type')); ?>"><i class="fa fa-circle-o"></i> 浏览分类</a></li>
                <li><a href="<?php echo e(url('admin/type/create')); ?>"><i class="fa fa-circle-o"></i> 添加分类</a></li>
              </ul>
            </li>
            ...
            <a href="">
 			      ...
 			      <ul class="treeview-menu">
                <li class="active"><a href="<?php echo e(url('admin/admin/ad')); ?>"><i class="fa fa-circle-o"></i> 广告详情</a></li>
                <li><a href="<?php echo e(url('admin/admin/log')); ?>"> <i class="fa fa-circle-o"></i> 日志详情</a></li>
              </ul>
            </li>
          ...
          <li class="active treeview">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="<?php echo e(url('admin/cmt')); ?>"><i class="fa fa-circle-o"></i> 浏览评论</a></li>
              </ul>
            </li>      
             ...
             <li class="active treeview">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="<?php echo e(url('admin/film_info')); ?>"><i class="fa fa-circle-o"></i> 浏览视频</a></li>
                <li><a href="<?php echo e(url('admin/film_info/create')); ?>"><i class="fa fa-circle-o"></i> 添加视频</a></li>
              </ul>
            </li>
            <li class="active treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="<?php echo e(url('admin/qiniu_info')); ?>"><i class="fa fa-circle-o"></i> 浏览七牛云</a></li>
                <li><a href="<?php echo e(url('admin/qiniu_info/create')); ?>"><i class="fa fa-circle-o"></i> 添加七牛云</a></li>
              </ul>
            </li>
