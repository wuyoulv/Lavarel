...
<div class="g-header g-header-fixed " id="qheader">
	<div class="g-header-container">
		<div class="g-box">
			<div class="yk-logo">
				<a href="<?php echo e(url('home/')); ?>" title="Youku 优酷" attr="idx0"><img src="<?php echo e(asset('home6/yk-logo-1220.png')); ?>" width="140" height="50" alt="Youku 优酷" from="index"></a>
			</div>
			<div class="g-view">
...
<div class="content" _uc="setting" id="profile">
	<div class="formbox">
			<fieldset>	
				...
				<form action="<?php echo e(url('home/userdetail/update')); ?>" method="post" id="sv_profile" enctype="multipart/form-data">
				...
				<div class="entry" width="80">
					...
					<div class="entry">
						<label>账号：</label>
						<input readonly placeholder="账号" type="text" value="<?php echo e($list['account']); ?>" style="width:125px;" name="account"  class="form_input"/>
					</div>
					<div class="entry">
					  <label></label>
