                ...
                <form action="{{URL('admin/user')}}/{{ $user->id }}" method="post" class="form-horizontal">
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                      <input  id="inputEmail3" placeholder="会员号" type="text" name="id" class="form-control" value="{{ $user->id }}"/>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                      <input  id="inputEmail3" placeholder="账号" type="text" name="account" class="form-control" value="{{ $user->account }}"/>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                      <input  id="inputEmail3" placeholder="头像" type="text" name="picname" class="form-control" value="{{ $user->picname }}"/>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                      <input  id="inputEmail3" placeholder="真实姓名" type="text" name="name" class="form-control" value="{{ $user->name }}"/>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                      <input  id="inputEmail3" placeholder="生日" type="text" name="birthday" class="form-control" value="{{ $user->birthday }}"/>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                      <input  id="inputEmail3" placeholder="电话" type="text" name="tel" class="form-control" value="{{ $user->tel }}"/>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                      <input  id="inputEmail3" placeholder="邮箱" type="text" name="email" class="form-control" value="{{ $user->email }}"/>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                      <input  id="inputEmail3" placeholder="地址" type="text" name="address" class="form-control" value="{{ $user->address }}"/>
